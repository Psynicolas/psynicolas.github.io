...
<head>
    ...
    <title>Nicolas Fernandez - Professional Profile</title>
    <style>
        ...
        img {
            max-width: 100%;
            height: auto;
            display: block; /* Ensures images are block-level for margin auto */
            margin: 0 auto; /* Center images */
        }
        em {
            font-style: italic;
            display: block; /* Make caption on its own line */
            text-align: center;
            margin-top: 5px;
            color: #555;
            font-size: 0.9em;
        ...
        details summary h2 {
            display: inline; /* Keep summary h2 inline with the triangle */
            margin: 0;
        }
        /* Style for the content inside details to ensure Markdown rendering */
        details p, details ul, details h3 {
            padding-left: 15px; /* Indent content within details */
        }
        details ul {
            padding-left: 35px; /* Further indent lists */
        }
        /* Specific styling for badges/shields */
        .badge {
